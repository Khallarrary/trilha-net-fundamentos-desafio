namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void RemoverVeiculo()
        {
            ...
            // Verifica se o veículo existe atraves da variavel placa
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {

                // *Implementado 

                // Solicita para o usuário digitar a quantidade de horas que o veículo permaneceu estacionado e armazena da variavel horas
                Console.WriteLine("Digite a quantidade de horas que o veículo permaneceu estacionado:");

                int horas = Convert.ToInt32(Console.ReadLine());

                // Realiza cálculo do total: "precoInicial + precoPorHora * horas" para a variável valorTotal
